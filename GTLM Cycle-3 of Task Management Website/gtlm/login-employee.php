			...
			<div class="cr-vr-task wd100">
				...
				<div class="right-area l-space">
					...
					<div class="m-e-toggle">
						<span class="admin-t"><a href="login.php">Admin</a></span>
						<span class="manager-t "><a href="login-manager.php">Manager</a></span>
						<span class="employee-t active"><a href="login-employee.php">Employee</a></span>
					</div>
					<form class="left-side admin-side active" method="post">
						<input type="text" name="email" placeholder="Email / Employee Id" required>
						...
						<a href="register.php?type=employee" class="btn btn-transparent">Register</a>
					</form>
