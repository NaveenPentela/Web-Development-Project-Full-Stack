			...
			<div class="cr-vr-task wd100">
				...
				<div class="right-area l-space">
					...
					<div class="m-e-toggle">
						...
						<span class="manager-t active"><a href="login-manager.php">Manager</a></span>
						<span class="employee-t"><a href="login-employee.php">Employee</a></span>
					</div>
					<form class="left-side admin-side active" method="post">
						<input type="text" name="email" placeholder="Email / Manager Id" required>
						...
						<a href="register.php?type=manager" class="btn btn-transparent">Register</a>
					</form>
